...
//static t_int *chopper_perform_stereo(t_int *w);
//static t_int *choppermono_perform(t_int *w);
//static t_int *chopper_perform_stereo_nointerpol(t_int *w);
//static t_int *chopper_perform_mono(t_int *w);
static t_int *chopper_pd_perform(t_int *w);
static void chopper_dsp(t_chopper *x, t_signal **sp);
static void chopper_set(t_chopper *x, t_symbol *s);
static void chopper_mute(t_chopper *x, t_floatarg toggle);
static void chopper_increment_adjust(t_chopper *x, t_floatarg toggle);
static void chopper_adjust_inverse(t_chopper *x, t_floatarg toggle);
static void *chopper_new(t_symbol *msg, int argc, t_atom *argv);
//static void chopper_in1(t_chopper *x, long n);
static void chopper_set_minincr(t_chopper *x, t_floatarg n);
static void chopper_set_maxincr(t_chopper *x, t_floatarg n);
static void chopper_set_minseg(t_chopper *x, t_floatarg n);
static void chopper_set_maxseg(t_chopper *x, t_floatarg n);
static void chopper_taper(t_chopper *x, t_floatarg f);
...
static void chopper_set_loop(t_chopper *x, t_symbol *msg, int argc, t_atom *argv);
static void chopper_randloop( t_chopper *x);
static void chopper_store_loop(t_chopper *x, t_floatarg loop_bindex);
static void chopper_recall_loop(t_chopper *x,  t_floatarg loop_bindex);
static void chopper_free(t_chopper *x) ;
static void chopper_retro_odds(t_chopper *x, t_floatarg f);
static void chopper_jitter(t_chopper *x, t_floatarg f);
static void chopper_jitterme(t_chopper *x);
static void chopper_rdur(t_chopper *x, t_floatarg f);
static void chopper_rdurme(t_chopper *x);
static void chopper_rinc(t_chopper *x, t_floatarg f);
static void chopper_rincme(t_chopper *x);
static void chopper_adjust_inverse(t_chopper *x, t_floatarg toggle);
//static t_int *chopper_performtest(t_int *w);
static void chopper_init(t_chopper *x, short initialized);
static void chopper_seed(t_chopper *x, t_floatarg seed);
static void chopper_testrand(t_chopper *x);
